...
import { getAnimeCharactersById, getAnimeDetailById, getAnimeEpisodesById } from '@/app/services/AnimeService'
...
const AnimeDetailPage = async ({ params: { id } }: Props) => {
    const [anime, episodes, characters] = [
        await getAnimeDetailById(id),
        await getAnimeEpisodesById(id),
        await getAnimeCharactersById(id),
    ]
    ...
    return (
        <div className='container mx-auto flex flex-col px-3 py-5 lg:mt-5 xl:p-0'>
                    ...
                    <div className='flex flex-col items-center lg:items-start mb-5'>
                        ...
                        <div className='flex items-center gap-4'>
                            <div className='flex items-center gap-1'>
                                ...
                                <span className='text-md'>{(anime.score) ? anime.score : "No rating"}</span>
                            </div>
                            <div>
