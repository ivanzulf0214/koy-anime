...
const AnimeCard = ({ anime }: Props) => {
    return (
        <Link href={`/details/${anime.mal_id}`} className="relative">
            <Image src={anime.images.webp.large_image_url} width={500} height={1000} alt={anime.title} className='w-full h-[280px] lg:h-[350px] object-cover rounded-lg'></Image>
